...
def connect():
    conn = pymysql.connect(host='localhost', user='jyp', password='wldbs11', db='wallofsheep', charset='utf-8')
...
def main():
	...
	cur.execute(sql, (parsePkt(pkt)[0], parsePkt(pkt)[1], '127.0.0.1', parsePkt(pkt)[2], 'cookie'))
